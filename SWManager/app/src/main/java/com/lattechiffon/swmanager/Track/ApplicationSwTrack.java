...
import com.lattechiffon.swmanager.Project.MyPortFolio;
...
public class ApplicationSwTrack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_application_sw_track);
        pref = getSharedPreferences("UserData", Activity.MODE_PRIVATE);
        settingPref = PreferenceManager.getDefaultSharedPreferences(this);

        texview = (TextView)findViewById(R.id.aswtrackText);

        userID = pref.getString("id","122088");

        imageButtons = new ImageButton[9];

        imageButtons[0] = (ImageButton)findViewById(R.id.app_sw_node1);
        imageButtons[1] = (ImageButton)findViewById(R.id.app_sw_node2);
        imageButtons[2] = (ImageButton)findViewById(R.id.app_sw_node3);
        imageButtons[3] = (ImageButton)findViewById(R.id.app_sw_node4);
        imageButtons[4] = (ImageButton)findViewById(R.id.app_sw_node5);
        imageButtons[5] = (ImageButton)findViewById(R.id.app_sw_node6);
        imageButtons[6] = (ImageButton)findViewById(R.id.app_sw_node7);
        imageButtons[7] = (ImageButton)findViewById(R.id.app_sw_node8);
        imageButtons[8] = (ImageButton)findViewById(R.id.app_sw_node9);
        ...
        Log.i("test","trackdata  = "+trackRealData[0] + " "+trackRealData[1]+" USERID="+userID);
        if(!trackRealData[1].contains("empty")) {

            if(Integer.parseInt(trackRealData[1])>=6)
                texview.setText("수료 하셨습니다.");
            else
            {
                int num = Integer.parseInt(trackRealData[1]);
                texview.setText(" "+num+"/6 개 수강하셨습니다.");
            }
